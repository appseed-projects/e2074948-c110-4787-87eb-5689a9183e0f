...
- Timestamp: `2022-06-04 00:27`
- Build ID: `e2074948-c110-4787-87eb-5689a9183e0f`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/e2074948-c110-4787-87eb-5689a9183e0f.git
$ cd e2074948-c110-4787-87eb-5689a9183e0f
```
